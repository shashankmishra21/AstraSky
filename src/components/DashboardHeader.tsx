...
export function DashboardHeader({ isDarkMode }: DashboardHeaderProps) {
  return (
    <motion.div
      ...
      className="text-center mb-10 md:mb-16 relative w-full px-2 sm:px-6"
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden w-full h-28 md:h-32 lg:h-40">
        ...
        >
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 150" preserveAspectRatio="none">
            {/* ...svg lines unchanged... */}
            {/* (Keep your motion.line sections here) */}
          </svg>
          {/* Constellation stars */}
      ...
      <div className="relative inline-block mb-2 md:mb-6 w-full">
        ...
        >
          {/* Orbit circle */}
          <motion.div
            className="relative w-10 h-10 md:w-16 md:h-16" // smaller on mobile
            animate={{ rotate: 360 }}
          ...
          >
            ...
            <motion.div
              className={`absolute top-0 left-1/2 w-2 h-2 md:w-3 md:h-3 -ml-1 -mt-1 md:-ml-1.5 md:-mt-1.5 rounded-full ${
                isDarkMode
          ...
          {/* Title */}
          <h1 className={`text-4xl sm:text-5xl md:text-7xl lg:text-8xl tracking-tight font-serif break-words ${
          ...
          >
            <div className={`absolute inset-0 rounded-full ${
              isDarkMode ? 'bg-gradient-to-br from-yellow-200 to-yellow-400' : 'bg-gradient-to-br from-yellow-400 to-yellow-600'
            }`}
            style={{
              boxShadow: isDarkMode
        ...
        <motion.p
          ...
          className={`text-lg sm:text-xl md:text-2xl mt-2 md:mt-4 tracking-wide ${
      ...
      {/* Location & sites badge */}
      <motion.div
        className={`inline-flex flex-col sm:flex-row items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full backdrop-blur-xl ${
          isDarkMode
